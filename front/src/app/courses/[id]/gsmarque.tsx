    ...
    <div className="w-screen bg-darkblue py-12 relative overflow-hidden">
      ...
      <div className=" space-y-2">
        <div className="bg-lightblue  flex   space-x-2 justify-between bg-opacity-20 animate-marquee">
          <p className="text-white  md:text-8xl py-1 px-1 font-semibold">
            GrowthSquare{" "}
          </p>
          <p className="text-white  md:text-8xl  py-1 px-1 font-semibold">. </p>{" "}
          <p className="text-white  md:text-8xl font-semibold">GrowthSquare </p>
          <p className="text-white  md:text-8xl py-1 px-1 font-semibold">
            .{" "}
          </p>{" "}
          <p className="text-white  md:text-8xl font-semibold">GrowthSquare </p>
