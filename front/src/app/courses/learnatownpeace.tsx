...
const LearnAtYourPace = () => {
    return (
        <section className="flex justify-between items-center bg-lightblue lg:py-0 py-10 lg:h-screen px-8 lg:px-28 ">
            {/* Left Side - Images */}
            <div className=" text-white hidden lg:flex flex-col gap-10 ">
